-- ============================================
-- DATOS SEMILLA (SEED) - Datos de prueba
-- ============================================
...
-- ============================================
-- USUARIOS
-- Contraseñas: admin123, coord123, user123
-- (bcrypt hashes generados con 10 rounds)
-- ============================================
INSERT INTO users (name, email, password_hash, role, phone) VALUES
('Administrador General', 'admin@academico.cl', '$2b$10$placeholder_admin_hash', 'admin', '+56912345678'),
('María González', 'maria.gonzalez@academico.cl', '$2b$10$placeholder_coord_hash', 'coordinator', '+56923456789'),
('Carlos Pérez', 'carlos.perez@academico.cl', '$2b$10$placeholder_coord_hash', 'coordinator', '+56934567890'),
('Ana Rodríguez', 'ana.rodriguez@academico.cl', '$2b$10$placeholder_user_hash', 'user', '+56945678901'),
('Luis Martínez', 'luis.martinez@academico.cl', '$2b$10$placeholder_user_hash', 'user', '+56956789012'),
('Sofía Hernández', 'sofia.hernandez@academico.cl', '$2b$10$placeholder_user_hash', 'user', '+56967890123'),
('Diego Morales', 'diego.morales@academico.cl', '$2b$10$placeholder_user_hash', 'user', '+56978901234'),
('Valentina Soto', 'valentina.soto@academico.cl', '$2b$10$placeholder_user_hash', 'user', '+56989012345'),
('Fernando López', 'fernando.lopez@academico.cl', '$2b$10$placeholder_user_hash', 'user', '+56990123456'),
('Camila Díaz', 'camila.diaz@academico.cl', '$2b$10$placeholder_user_hash', 'user', '+56901234567');
...
-- ============================================
-- HISTORIAL DE ASISTENCIA (datos simulados)
-- ============================================
INSERT INTO attendance_history (program_id, month, year, total_registered, total_attended, attendance_rate) VALUES
(1, 1, 2026, 40, 34, 85.00),
(1, 2, 2026, 38, 30, 78.95),
(1, 3, 2026, 42, 36, 85.71),
(2, 1, 2026, 55, 45, 81.82),
(2, 2, 2026, 52, 40, 76.92),
(2, 3, 2026, 58, 50, 86.21),
(3, 1, 2026, 90, 78, 86.67),
(3, 2, 2026, 88, 72, 81.82),
(3, 3, 2026, 92, 80, 86.96),
(5, 1, 2026, 35, 30, 85.71),
(5, 2, 2026, 33, 26, 78.79),
(5, 3, 2026, 36, 31, 86.11);
