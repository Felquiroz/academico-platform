...
import { HiOutlineCheck, HiOutlineX, HiOutlinePlus, HiOutlineClock, HiOutlineOfficeBuilding, HiOutlineClipboardList } from 'react-icons/hi';
    ...
    <div className="fade-in">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Aprobar o rechazar solicitudes de salas y actividades</p>
        </div>
      ...
      <div className="filters-bar">
        <button className={`btn ${filter === 'pending' ? 'btn-primary' : 'btn-secondary'}`} onClick={() => setFilter('pending')}>
          <HiOutlineClock /> Pendientes ({requests.filter(r => r.status === 'pending').length})
        </button>
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-group">
                ...
                <select className="form-select" value={form.type} onChange={e => setForm({ ...form, type: e.target.value })}>
                  <option value="room">Solicitud de Sala</option>
